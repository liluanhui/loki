...
import publicLetter from "./components/public-letter.vue";
...
const componentObj = computed(() => {
  return { menus, write: isLogin() ? write : menus, confirm, close, loginOption, publicLetter };
});
