<template>
  <div :class="clsBlockName" style="justify-content: space-between">
    ...
    <router-link v-if="type === 'menu'" custom v-for="(v, k) in navItem" :to="v.to" v-slot="{ navigate, isExactActive }">
